...
def main():
    ...
    # no modulation, so g is not important. set tonic_g as input tonic g in case need neuro activity for observation
    ...
    for j in range(num_updates):
        for step in range(args.num_steps):
            ...
            #update evaluations if need its stats
            with torch.no_grad():
