...
def get_args():
    ...
    parser.add_argument('--log-dir', default='./gym/',
                        help='directory to save agent logs (default: ./gym)')
    parser.add_argument('--save-dir', default='./trained_models/',
                        help='directory to save agent logs (default: ./trained_models/)')
    parser.add_argument('--reward-dir', default='./rewards/',
                        help='directory to save agent logs (default: ./rewards/)')
    ...
    parser.add_argument('--reward-mode', type=int, default=0, 
                        help='0: clip rewards, 1: original rewards, 2: scaled rewards')
