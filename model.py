...
class Policy(nn.Module):
    ...
    def act(self, inputs, rnn_hxs, masks, modulate, g, mean_entropy, entropy_base, deterministic=False):
        ...
        g = get_g_entropy(dist_entropy_pre, g, mean_entropy, entropy_base)
        if modulate:
