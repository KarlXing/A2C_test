...
class CNNBase(NNBase):
    def __init__(self, obs_shape, activation, recurrent=False, hidden_size=512):
        ...
        self.conv1_2 = init_(nn.Conv2d(num_inputs, 32, 8, stride=4))
        self.conv2_2 = init_(nn.Conv2d(32, 64, 4, stride=2))
        self.conv3_2 = init_(nn.Conv2d(64, 32, 3, stride=1))
        ...
        self.f_2 = init_(nn.Linear(x.shape[-1], hidden_size))
